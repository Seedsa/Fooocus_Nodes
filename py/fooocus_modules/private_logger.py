...
from fooocus_modules.util import generate_temp_filename
...
def get_current_html_path():
    date_string, local_temp_filename, only_name = generate_temp_filename(folder=fooocus_modules.config.path_outputs,
                                                                         extension='png')
...
def log(img, dic):
    ...
    date_string, local_temp_filename, only_name = generate_temp_filename(folder=fooocus_modules.config.path_outputs, extension='png')
