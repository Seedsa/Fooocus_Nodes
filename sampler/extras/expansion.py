...
from config import path_fooocus_expansion
...
class FooocusExpansion:
    def __init__(self):
        ...
        print(f'Fooocus V2 提示词智能扩展：包含{len(debug_list)}个单词的词汇表。')
        ...
        print(f'Fooocus 提示词智能扩展引擎已加载至 {load_device}, use_fp16 = {use_fp16}.')
