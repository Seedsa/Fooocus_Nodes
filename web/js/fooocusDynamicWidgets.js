...
function widgetLogic(node, widget) {
	...
	if (widget.name === 'generation_mode') {
		...
		if (widget.value === 'inpaint') {
			toggleWidget(node, findWidgetByName(node, 'inpaint_respective_field'), true)
...
const getSetWidgets = ['image_output', 'num_loras', 'toggle', 'resolution', "generation_mode", 'settings']
